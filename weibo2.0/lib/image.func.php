...
function thumb($filename,$destination=null,$dst_w=null,$dst_h=null,$isReservedSource=true,$scale=0.5){
    ...
    //$src_image=imagecreatefrom$mime($filename);
    /* $mime2=end(explode("/",$mime));*/
    //echo $mime2;
    /*if($mime2=='jpeg'){
    ...
    /*if($mime2=='jpeg'){
        imagejpeg($dst_image,$dstFilename);
    }*/
...
function waterText($filename,$text="imooc.com",$fontfile="SIMYOU.TTF"){
